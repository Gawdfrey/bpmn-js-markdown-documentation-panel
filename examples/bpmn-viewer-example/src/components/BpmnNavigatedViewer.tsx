...
interface BpmnNavigatedViewerProps {
  xml: string;
  className?: string;
}

const BpmnNavigatedViewer: React.FC<BpmnNavigatedViewerProps> = ({
  xml,
  className,
}) => {
  ...
  useEffect(() => {
    ...
    // Create BPMN navigated viewer with documentation extension
    ...
    viewer
      .importXML(xml)
      .then(() => {
        console.log("BPMN diagram imported successfully in navigated viewer");
